...
public class Main {
    public static void main(String[] args) {
        ...
        Procesador procesador0 = new Procesador();
        procesador0.imprimirDatos();
        Procesador procesador1 = new Procesadores_moviles();
        procesador1.imprimirDatos();
        Procesador procesador2 = new Procesadores_Amd();
        procesador2.imprimirDatos();
